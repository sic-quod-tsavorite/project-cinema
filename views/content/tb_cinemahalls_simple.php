            ...
            <?php foreach ($cinemaHalls as $hall): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Delete Form -->
                        <form action="<?php echo $base_url; ?>/admin-board" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this cinema hall? (A hall can only be deleted if there are no movie showings and booked tickets connected to it.)');">
                            <input type="hidden" name="cinemaHallID" value="<?php echo htmlspecialchars($hall['cinemaHallID']); ?>">
